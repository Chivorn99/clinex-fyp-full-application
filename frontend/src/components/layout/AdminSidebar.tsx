...
export default function AdminSidebar() {
  ...
  return (
    <aside
      className={`${
        collapsed ? 'w-18' : 'w-70'
      } min-h-screen bg-linear-to-b from-slate-900 via-slate-850 to-slate-800 border-r border-slate-700/50 flex flex-col transition-all duration-300 ease-in-out`}
    >
      {/* Header */}
      <div className="p-4 border-b border-slate-700/50">
        <div className="flex items-center justify-between">
          <div className={`flex items-center gap-3 ${collapsed ? 'justify-center w-full' : ''}`}>
            <div className="h-9 w-9 rounded-lg bg-linear-to-br from-indigo-500 to-purple-600 flex items-center justify-center shrink-0 shadow-lg shadow-indigo-500/20">
          ...
          return (
            <Link
              ...
              className={`flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 group relative ${
                active
                  ? 'bg-indigo-600/20 text-white border-l-[3px] border-indigo-400 ml-0 pl-2.25'
      ...
      <div className="border-t border-slate-700/50 p-4 space-y-3">
        {!collapsed && user && (
          <div className="flex items-center gap-3 px-2">
            <div className="h-8 w-8 rounded-full bg-linear-to-br from-indigo-500 to-purple-500 flex items-center justify-center text-white text-xs font-bold shrink-0 overflow-hidden relative">

...
const AVAILABLE_PERMISSIONS = [
  {
    key: "manage_users",
    label: "Manage Users",
    description: "Create, edit, delete users and change roles",
  },
  {
    key: "manage_templates",
    label: "Manage Templates",
    description: "Create and edit OCR extraction templates",
  },
  {
    key: "manage_reports",
    label: "Manage Reports",
    description: "Delete and reprocess reports in bulk",
  },
  {
    key: "view_analytics",
  ...
  },
  {
    ...
    description: "Monitor Ollama, queue, and disk status",
  },
  {
    key: "export_data",
    label: "Export Data",
    description: "Export reports and data as CSV",
  },
];
...
export default function UsersPage() {
  ...
  const handlePermissionToggle = async (
    ...
    try {
      ...
      setUsers((prev) =>
        prev.map((u) =>
          u.id === userId ? { ...u, permissions: newPerms } : u,
        ),
      );
    } catch (err) {
      showToast(
    ...
    <div className="p-6 lg:p-8 max-w-6xl mx-auto space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-500 mt-1">
          {total} user{total !== 1 ? "s" : ""} total. Manage roles and granular
          permissions.
        </p>
      </div>
        ...
        {loading ? (
          ...
          <div className="divide-y divide-gray-100">
            {users.map((u) => {
              ...
              const avatarUrl =
                typeof u.profile_picture_url === "string" &&
                u.profile_picture_url.length > 0
                  ? u.profile_picture_url
                  : typeof u.profile_pic === "string" &&
                      u.profile_pic.length > 0
                ...
                >
                  ...
                  <div className="p-4 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      {/* Avatar */}
                      <div className="h-10 w-10 rounded-full bg-linear-to-br from-indigo-400 to-purple-500 flex items-center justify-center text-white text-sm font-bold shrink-0 overflow-hidden relative">

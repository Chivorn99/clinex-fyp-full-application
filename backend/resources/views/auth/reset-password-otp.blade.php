...
<head>
    ...
    <title>Reset Password - ClinicSync Admin</title>
...
<body class="bg-gray-100 min-h-screen flex items-center justify-center font-inter">
    <div class="w-full max-w-md mx-auto p-6">
        <div class="bg-white rounded-xl shadow-lg p-8">
            ...
            <h2 class="text-xl font-semibold text-center text-blue-900 mb-6">Create New Password</h2>
            ...
            <form method="POST" action="{{ route('password.otp.reset') }}">
                ...
                <!-- Confirm Password -->
                <div class="mb-4">
                    <label for="password_confirmation" class="block mb-2 text-sm font-medium text-gray-700">Confirm New
                        Password</label>
